...
import com.example.batch.processor.DetailItemProcessor;
...
public class BatchConfig {
    ...
    @Bean
    public Step parseToXmlStep(JobRepository jobRepository,
    ...
    @Bean
    public Step preParseStep(JobRepository jobRepository,
            PlatformTransactionManager transactionManager,
    ...
    @Bean
    public Step detailChunkStep(JobRepository jobRepository,
            PlatformTransactionManager transactionManager,
    ...
    @Bean
    public Step finalizeXmlStep(JobRepository jobRepository,
            PlatformTransactionManager transactionManager,
    ...
    @Bean
    public Job parseToXmlChunkJob(JobRepository jobRepository,
            Step preParseStep,
